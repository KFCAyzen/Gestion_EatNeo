...
export const menuItems: MenuItem[] = [
  ...
  // Nouveaux plats - Petit Déjeuner
  {
    id: 33,
    nom: "Spaghetti sauté simple",
    prix: "1000 FCFA",
    image: "/spaghetti_simple.jpg",
